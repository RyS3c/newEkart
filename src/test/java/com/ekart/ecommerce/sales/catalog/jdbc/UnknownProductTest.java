...
class UnknownProductTest {
    ...
    void unknown_product_has_values() {
        ...
        assertAll(
                ...
                () -> Assertions.assertThat(unknownProduct.price()).isNotNull()
        );
    }
    ...
    void unknown_product_has_a_zero_price() {
        Product unknownProduct = new UnknownProduct();
        Assertions.assertThat(unknownProduct.price()).isEqualTo(new Money(0.f));
    }
    ...
    void change_price_noop() {
        ...
        Assertions.assertThat(unknownProduct.price()).isEqualTo(unknownMoney);
    }
